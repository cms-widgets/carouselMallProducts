...
public class WidgetInfo implements Widget, PreProcessWidget {
    ...
    public String groupId() {
        return "com.huotu.hotcms.widget.carouselMallProducts";
    }

    @Override
    public String widgetId() {
        return "carouselMallProducts";
    }
    ...
    public String description(Locale locale) {
        if (locale.equals(Locale.CHINA)) {
            return "这是一个商城产品轮播器，你可以对组件进行自定义修改。";
        }
        return "This is a carouselMallProducts,  you can make custom change the component.";
    }
